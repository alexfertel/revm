...
## [6.0.0](https://github.com/alexfertel/revm/compare/revm-primitives-v5.0.0...revm-primitives-v6.0.0) - 2024-07-04

### Added
- *(Prague)* Add EIP-7702 ([#1565](https://github.com/alexfertel/revm/pull/1565))
- add helper function to mape EVMError's Database error variant ([#1567](https://github.com/alexfertel/revm/pull/1567))

### Other
- *(README)* add rbuilder to used-by ([#1585](https://github.com/alexfertel/revm/pull/1585))
- add utility function AccountInfo::from_bytecode ([#1577](https://github.com/alexfertel/revm/pull/1577))
